...
export default function LogoutModal() {
    return (
        <div id="hs-sign-out-alert" className="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[70] overflow-x-hidden overflow-y-auto">
