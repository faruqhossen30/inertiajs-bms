...
import { BanknotesIcon, ClipboardIcon, GlobeAltIcon, InformationCircleIcon } from '@heroicons/react/24/outline';
import WebsiteTitle from './WebsiteTitle';
import HeaderNotice from './HeaderNotice';
import SponserCommission from './SponserCommission';
            ...
            <div className="bg-white dark:bg-gray-800 dark:text-slate-400 p-2 m-2">
                <div className="flex">
                    <div className="border-r border-gray-200 dark:border-gray-700">
                        ...
                        <button type="button" className="hs-tab-active:border-blue-500 hs-tab-active:text-blue-600 dark:hs-tab-active:text-blue-600 py-1 pr-4 inline-flex items-center gap-2 border-r-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-blue-600 dark:hover:text-gray-300 active" id="vertical-tab-with-border-item-2" data-hs-tab="#vertical-tab-with-border-1" aria-controls="vertical-tab-with-border-1" role="tab">
                            ...
                            <button type="button" className="hs-tab-active:border-blue-500 hs-tab-active:text-blue-600 dark:hs-tab-active:text-blue-600 py-1 pr-4 inline-flex items-center gap-2 border-r-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-blue-600" id="vertical-tab-with-border-item-2" data-hs-tab="#vertical-tab-with-border-2" aria-controls="vertical-tab-with-border-1" role="tab">
