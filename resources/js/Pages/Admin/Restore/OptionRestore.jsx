        ...
        <AuthenticatedLayout>
            ...
            <div className="flex flex-col bg-white border rounded-lg border-gray-200 shadow-sm m-1 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
                ...
                <div className="overflow-x-auto">
                        ...
                        <TBody>
                            {
                                options.data.map((item, index) => {
                                    return <tr key={index}>
                                        ...
                                        <td className="h-px w-px whitespace-nowrap">
                                            <div className="px-2 py-2">
                                                <span className="text-sm text-gray-600 dark:text-gray-400">{item.question.title}</span>
                                            </div>
                                        </td>
                                        <td className="h-px w-px whitespace-nowrap">
                                            <div className="px-2 py-2">
                    ...
                    <hr />
                    <Pagination pagination={options} links={options.links} />
                </div>
            </div>
