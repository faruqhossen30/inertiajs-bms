...
export default function MatcheRestore({ matches }) {
    console.log(matches);
    return (
        <AuthenticatedLayout>
            ...
            <div className="flex flex-col bg-white border rounded-lg border-gray-200 shadow-sm m-1 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
                ...
                <div className="overflow-x-auto">
                    ...
                    <hr />
                    <Pagination pagination={matches} links={matches.links} />
                </div>
            </div>
