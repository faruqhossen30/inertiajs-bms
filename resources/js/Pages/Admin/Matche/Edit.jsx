...
export default function Edit({ games, countries, matche }) {
    const { data, setData, post, put, processing, errors, reset } = useForm({
        ...
        date_time: moment(matche.date_time).tz("Asia/Dhaka").format('y-M-D hh:mm:ss'),
                                ...
                                <div className="max-w-[85rem] px-2 py-1 sm:px-6 lg:px-4 mx-auto">
                                    <form onSubmit={submit}>
                                        <div>
                                            ...
                                            <Input id="team_one" type="text" name="team_one" defaultValue={data.team_one} autoComplete="Team One" placeholder="Team One" onChange={(e) => setData('team_one', e.target.value)} />
                                            <p className="text-sm text-red-600 mt-2">{errors.team_one}</p>
                                        </div>

                                        <div>
                                            <InputLabel labelFor="Team Two" isRequired={true} />
                                            <Input id="team_two" type="text" name="team_two" defaultValue={data.team_two} autoComplete="Team Two" placeholder="Team Two" onChange={(e) => setData('team_two', e.target.value)} />
                                        ...
                                        <div>
                                            ...
                                            <select id="team_one_flag" name="team_one_flag" className="py-3 px-4 pr-9 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                                                defaultValue={matche.team_one_flag}
                                        ...
                                        <div>
                                            ...
                                            <select id="team_two_flag" name="team_two_flag" className="py-3 px-4 pr-9 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
                                                defaultValue={matche.team_two_flag}
                                        ...
                                        <div>
                                            ...
                                            <Input id="statement" type="text" name="statement" defaultValue={data.statement} autoComplete="Statement" placeholder="Statement" onChange={(e) => setData('statement', e.target.value)} />
                                            <p className="text-sm text-red-600 mt-2">{errors.statement}</p>
                                        </div>

                                        <div>
                                            <InputLabel labelFor="Date & Time" isRequired={true} />
                                            <Input id="date_time" type="datetime-local" name="date_time" defaultValue={data.date_time} autoComplete="date_time" placeholder="date_time" onChange={(e) => setData('date_time', e.target.value)} />
                                            <p className="text-sm text-red-600 mt-2">{errors.date_time}</p>
                                        </div>

                                        <div>
                                            <InputLabel labelFor="Note" />
                                            <Input id="note" type="text" name="note" defaultValue={data.note} autoComplete="note" placeholder="Note" onChange={(e) => setData('note', e.target.value)} />
