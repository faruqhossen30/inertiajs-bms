...
export default function Edit({matche,matchequestion}) {
    const { data, setData, put, processing, errors, reset } = useForm({
        title: matchequestion.title,
        status: true
    });
    ...
    function submit(e) {
        e.preventDefault()
        console.log(data);
        put(route('matchequestion.update',matchequestion.id));
    }
    return (
        <AuthenticatedLayout>
            <Head title="Autoquestion" />
            <Breadcum page="Matche Question" subpage="Edit" />
