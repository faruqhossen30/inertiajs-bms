...
import { ClipboardIcon, PlusCircleIcon, PlusIcon, PlusSmallIcon } from '@heroicons/react/24/outline';
                                                    ...
                                                    <div className="p-1.5 min-w-full inline-block align-middle">
                                                        <div className="overflow-hidden">
                                                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                                                <thead>
                                                                    <tr>
                                                                        <th scope="col" className="px-1 py-3 text-start text-xs font-medium text-gray-500 uppercase">S.N</th>
                                                                        <th scope="col" className="px-3 py-3 text-start text-xs font-medium text-gray-500 uppercase">Option</th>
                                                                        <th scope="col" className="px-3 py-3 text-start text-xs font-medium text-gray-500 uppercase">Rate</th>
                                                                        <th scope="col" className="px-3 py-3 text-end text-xs font-medium text-gray-500 uppercase">Action</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                                                    {
                                                                        options.map((item, index) => {
                                                                            return <tr key={index}>
                                                                                <td className="px-1 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                                                                    {item.id}
                                                                                </td>
                                                                                ...
                                                                                <td className="px-3 py-2 whitespace-nowrap text-end text-sm font-medium">
