            ...
            <div className=' space-x-1'>
                {auth.user ?
                    ...
                    <div className='hidden lg:block space-x-2'>
                            <Link className=' font-normal text-sm border rounded-sm text-purple-800 dark:text-gray-200 px-3 py-1'>Profile</Link>
                            <Link className=' font-normal text-sm border rounded-sm text-purple-800 dark:text-gray-200 px-3 py-1'>Statement</Link>
                            <Link href='/deposits' className=' font-normal text-sm border rounded-sm text-purple-800 dark:text-gray-200 px-3 py-1'>Deposit</Link>
                ...
                <span className='lg:hidden text-purple-800 font-bold dark:text-gray-200'>৳100</span> */}
            </div>
        </header>
    )
}
